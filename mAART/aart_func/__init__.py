...
from scipy.integrate import cumulative_trapezoid,quad,solve_ivp # ***Changed from cumtrapz to cumulative_trapezoid
...
#Warnings flags
warnings.filterwarnings("ignore", category=np.exceptions.VisibleDeprecationWarning) # ***Changed from np.VisibleDeprecationWarning to np.exceptions.VisibleDeprecationWarning
...
import aart_func.polprocess_f as polp

#QU computation
from scipy.spatial import cKDTree
import aart_func.calcQU_f as calcQU
